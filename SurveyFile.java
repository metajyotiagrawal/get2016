...
public class SurveyFile  {
	...
	int i = 0;
	String questions[] = new String[5];                   //question text
	int rating[] = new int[5];                              //rating of survey
	...
	public SurveyFile() {                //non-parameterized constructor of SurveyFile
	}

	/*public SurveyFile(int rat, String ques, int wr, String ms) {//parameterized constructor of SurveyFile
		this.rating[0] = rat;
		this.questions[0] = ques;
		this.multiselect[0] = ms;
		this.warranty[0] = wr;
	}*/
