...
public class ConnectionEstablish {
	...
	Statement st;
/*
 * to establish connection steps include
 * load or register driver
 * establish connection using connection class
 * create statement using statement class
 */
	public void getconnection() throws SQLException  {
		...
		Connection con = DriverManager.getConnection(mysqlURL, "root", "jyoti");
