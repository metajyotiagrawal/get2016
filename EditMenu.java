...
public class EditMenu {
	...
	public void check(){
		...
		if(submenu.equals("fontSize"))
		{
			getFontSize();
		}
		else if(submenu.equals("fontStyle"))
		{
			getFontStyle();
		}
		else
 ...
 */
	public void getFontStyle() {
		...
		if (fontSty.equals("Arial") || fontSty.equals("Denmark")|| fontSty.equals("CG Omega")
				|| fontSty.equals("Courier") || fontSty.equals("BinnerD")) {
